...
import { EvolutionaryAI } from '../../src/colony/simulation/ai/evolutionary-ai.ts'
import { createRandomGenome } from '../../src/colony/simulation/ai/genome.ts'
import { createRNG } from '../../src/shared/seed.ts'
import { createVillager } from '../../src/colony/simulation/villager.ts'
...
describe('EvolutionaryAI', () => {
  ...
  it('has no DOM dependencies', async () => {
    const mod = await import('../../src/colony/simulation/ai/evolutionary-ai.ts')
