...
import { SEASONAL_TINTS, getTileTint } from '../../src/colony/rendering/palette.ts'
import { TileType } from '../../src/colony/simulation/world.ts'
import type { Season } from '../../src/colony/simulation/villager.ts'
