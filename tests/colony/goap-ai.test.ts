...
import { createVillager, NeedType, getNeed } from '../../src/colony/simulation/villager.ts'
import { World } from '../../src/colony/simulation/world.ts'
import type { AIWorldView } from '../../src/colony/simulation/ai/ai-interface.ts'
import { snapshotWorldState } from '../../src/colony/simulation/ai/goap-world-state.ts'
import { GOAP_ACTIONS } from '../../src/colony/simulation/ai/goap-actions.ts'
import { GOAP_GOALS, selectGoal } from '../../src/colony/simulation/ai/goap-goals.ts'
import { planActions } from '../../src/colony/simulation/ai/goap-planner.ts'
