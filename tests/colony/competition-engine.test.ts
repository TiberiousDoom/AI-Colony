...
import { CompetitionEngine, type CompetitionConfig } from '../../src/colony/simulation/competition-engine.ts'
...
import { TICKS_PER_DAY, DAYS_PER_SEASON } from '../../src/colony/simulation/simulation-engine.ts'
