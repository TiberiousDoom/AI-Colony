...
import { EventScheduler, resolveEventPosition, type RandomEvent } from '../../src/colony/simulation/events.ts'
...
import { FLEE_ACTION } from '../../src/colony/simulation/actions.ts'
