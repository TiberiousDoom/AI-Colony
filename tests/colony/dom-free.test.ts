...
describe('DOM-free simulation', () => {
  ...
  it('seed.ts has no DOM imports', async () => {
    const mod = await import('../../src/shared/seed.ts')
    expect(mod.createRNG).toBeTypeOf('function')
  })

  it('noise.ts has no DOM imports', async () => {
    const mod = await import('../../src/shared/noise.ts')
  ...
  it('world.ts has no DOM imports', async () => {
    const mod = await import('../../src/colony/simulation/world.ts')
    expect(mod.World).toBeTypeOf('function')
  })

  it('actions.ts has no DOM imports', async () => {
    const mod = await import('../../src/colony/simulation/actions.ts')
  ...
  it('ai-interface.ts has no DOM imports', async () => {
    ...
    const mod = await import('../../src/colony/simulation/ai/ai-interface.ts')
    expect(mod).toBeDefined()
  })

  it('utility-ai.ts has no DOM imports', async () => {
    const mod = await import('../../src/colony/simulation/ai/utility-ai.ts')
    expect(mod.UtilityAI).toBeTypeOf('function')
  })

  it('simulation-engine.ts has no DOM imports', async () => {
    const mod = await import('../../src/colony/simulation/simulation-engine.ts')
    expect(mod.SimulationEngine).toBeTypeOf('function')
  })

  it('structures.ts has no DOM imports', async () => {
    const mod = await import('../../src/colony/simulation/structures.ts')
  ...
  it('events.ts has no DOM imports', async () => {
    const mod = await import('../../src/colony/simulation/events.ts')
  ...
  it('behavior-tree.ts has no DOM imports', async () => {
    const mod = await import('../../src/colony/simulation/ai/behavior-tree.ts')
  ...
  it('behavior-tree-ai.ts has no DOM imports', async () => {
    const mod = await import('../../src/colony/simulation/ai/behavior-tree-ai.ts')
    expect(mod.BehaviorTreeAI).toBeTypeOf('function')
  })

  it('competition-engine.ts has no DOM imports', async () => {
    const mod = await import('../../src/colony/simulation/competition-engine.ts')
  ...
  it('full simulation can run without DOM', async () => {
    ...
    const { SimulationEngine } = await import('../../src/colony/simulation/simulation-engine.ts')
    const { UtilityAI } = await import('../../src/colony/simulation/ai/utility-ai.ts')
  ...
  it('competition engine can run without DOM', async () => {
    const { CompetitionEngine } = await import('../../src/colony/simulation/competition-engine.ts')
    const { UtilityAI } = await import('../../src/colony/simulation/ai/utility-ai.ts')
    const { BehaviorTreeAI } = await import('../../src/colony/simulation/ai/behavior-tree-ai.ts')
