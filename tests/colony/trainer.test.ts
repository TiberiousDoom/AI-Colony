...
import { evaluateFitness } from '../../src/colony/training/fitness.ts'
import { runGeneration } from '../../src/colony/training/trainer.ts'
import { createRandomGenome, getGenomeNeedCount } from '../../src/colony/simulation/ai/genome.ts'
