...
} from '../src/simulation/structures.ts'
import { BUILD_SHELTER_ACTION, BUILD_STORAGE_ACTION, REST_ACTION, DEFAULT_CTX, type TickContext } from '../src/simulation/actions.ts'
